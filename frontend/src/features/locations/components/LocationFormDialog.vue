...
import { createEmptyLocationForm, locationToForm } from '../lib/location-form';
import { locationCategories, locationCategoryLabels, type Location, type LocationForm } from '../model/location';
